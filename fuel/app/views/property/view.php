			...
			<div class="col-md-12" style="background: rgba(233, 220, 220, 0.21);
				...
				<div class="row">
					<div class="col-md-8">
						...
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
							...
							<ol id="thumbnail">
								...
								?>
								<li id="property-img-add">
									<img style="width:100%; cursor:pointer;" src="<?php echo Uri::create('assets/img/add.jpg');?>">
								</li>
								<form id="property-image-form">
									<input type="file" style="display:none" name="profile-img" id="property-img-file"/>
								</form>
							</ol>
					...
					<div class="col-md-4">
						...
						<p>							
						<h4 style="font-size: 25px;"><?php echo $property->name;?></h4>
						</p>
